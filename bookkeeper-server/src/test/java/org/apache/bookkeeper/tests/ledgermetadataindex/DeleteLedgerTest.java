...
public class DeleteLedgerTest {
	...
	// Nel primo test viene sollevata dalla successiva chiamata a get() dopo aver
	// eliminato i metadati.
	// Nel secondo test viene sollevata direttamente dal metodo delete().
